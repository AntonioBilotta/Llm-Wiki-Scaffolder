...
- **INGEST** — drop a source under `raw/<subfolder>/` then run:
  ```
  /wiki-ingest raw/<subfolder>/<file>
  ```
...
_Define what this vault tracks. This is a `custom` / `hobby` vault, so the sections below are up to you._

## Main topics

_Central topics you want to accumulate knowledge about._

## Working themes

_Recurring threads or angles you keep returning to._
